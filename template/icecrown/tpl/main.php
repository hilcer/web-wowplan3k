            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="<?php echo $antiXss->xss_clean(get_config("baseurl")); ?>/template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/images/donaciones720.jpg"
                             alt="WoW" style="width:100%;">
                    </div>
                    <div class="item">
                        <img src="<?php echo $antiXss->xss_clean(get_config("baseurl")); ?>/template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/images/slide720.png"
                             alt="WoW" style="width:100%;">
                    </div>
                    <div class="item">
                        <img src="<?php echo $antiXss->xss_clean(get_config("baseurl")); ?>/template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/images/donaciones720.jpg"
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade in <?php echo((empty($error_error) && empty($success_msg)) ? 'active' : ''); ?>"
                        ...
                        <p style="text-align: justify">
                            Misterios de Azeroth es una expansión creada por fans para World of Warcraft Vanilla que profundiza en la exploración de la historia original del juego. Esta expansión busca tomar un camino diferente al de The Burning Crusade, enfatizando el Azeroth familiar de Vanilla WoW en lugar de la batalla cósmica contra la Legión Ardiente. Basada en gran medida en el lore de Warcraft 3 y Vanilla WoW, Misterios de Azeroth tiene como objetivo mejorar el juego agregando contenido que se alinea con la rica y bien establecida narrativa del universo de Warcraft.

                            ¡Prepárate para una nueva aventura que te llevará a recorrer Azeroth en una historia diseñada para ofrecer experiencias y aventuras completamente inéditas!
                        </p>
                        <p><?php elang('edit_on'); ?> Registrate YA!!!! </p>
                    </div>
                    <div class="tab-pane fade in <?php echo(!(empty($error_error) && empty($success_msg)) ? 'active' : ''); ?>"
                         id="pills-register">
                        <div class="row">
                    ...
                    if (!get_config('disable_top_players')) { ?>
                        <div class="tab-pane fade in" id="pills-topplayers">
                            ...
                            foreach (get_config('realmlists') as $onerealm_key => $onerealm) {
                                ...
                                echo "<div id=\"paypal-button-container\"></div><p id=\"result-message\"></p>";
...
//                                 echo "<hr>";
        ...
        <div class="col-md-4 sidebar">
            ...
            <form action="" method="post">
             ...
             <?php } ?>
            <div class="box1">
                <div id="paypal-button-container"></div><p id="result-message"></p>
            </div>
            <div class="box1">
                Discord
                <hr style="border-color: #00CCFF;">
                <iframe src="https://discordapp.com/widget?id=1372799626775756865&theme=dark" width="330"
